...
.global UnitInfoWindow_ShiftDrawRanks
.type UnitInfoWindow_ShiftDrawRanks, %function


		UnitInfoWindow_ShiftDrawRanks:
		push	{r4-r7,r14}
		mov		r4, r0
		mov		r5, r1 @unit
		...
		@Display rank after Shift
		cmp		r7, #0
		beq		DashesForSecondRankDisplay
		
			mov		r0, r5
			@ldr		r1, =DetermineShiftSeverity
			@mov		lr, r1
			@.short	0xF800
			@add		r7, r0
			ldr		r2, =WEXPRankRequirementsTable
