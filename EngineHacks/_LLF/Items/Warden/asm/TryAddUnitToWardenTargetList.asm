...
.global TryAddUnitToWardenTargetList
.type TryAddUnitToWardenTargetList, %function


		TryAddUnitToWardenTargetList:
		push	{r4,r14}
		mov		r4, r0
		ldr		r0, =gUnitSubject
		ldr		r0, [r0]
		...
		beq		End
			...
			bne		UnitNotAdded
				...
				@Check if unit already has 3 turns of warden buff
				mov		r0, r4
