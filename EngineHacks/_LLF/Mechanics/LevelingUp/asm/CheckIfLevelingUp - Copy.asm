...
.type CheckIfLevelingUp, %function
		...
		@now roll random number with growth
		ldrb	r0,[r4,r5]
		ldr		r3,=CalcLevelUp
		mov		r14,r3
		.short	0xF800
		...
		@strh	r7,[r13,#0x28] @store sum of growths
		mov		r0, r7
		bl		DivideBy100
		strb	r1,[r6,#0xA] @store sum of growths/100, rounded down
		...
		CheckIfRerolling:
		cmp		r1,#2
		blt		CheckIfHighestGainPassesCap
		...
		ldrb	r0,[r0,r1]
		cmp		r5,#6
		bne		CheckIfCharacterMaxHp2

		mov		r0,#30 @temporary luck thing for now

		CheckIfCharacterMaxHp2:
		cmp		r5,#0
		bne		LoadCurrentValue2
		...
		@strb	r2,[r4,#7] @if I need to store total number of increases
