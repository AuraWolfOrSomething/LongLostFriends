...
ldr		r0,Calc_Level_Up	@ load r8 with word at Calc_Level_Up, which is a rom address (2B9A0, to be precise)
mov		r8,r0
...
strb	r6,[r4,r5] @store total number of stat increases
ldr		r7,[r4,#0x18]
...
cmp		r5,#0
bne		DeviationCalculated @hp deviation is divided by 2 before being stored
lsr		r1,#1
...
add		r5,#1
cmp		r5,#7
blt		StoreStatDeviations

mov		r5,#0
mov		r6,r4
add		r6,#0x10

CheckForPositiveDeviation:
ldrb	r0,[r6,r5]
bl		DivideBy100
...
@otherwise, check sum of growths/100 and compare to number of stats increasing 
