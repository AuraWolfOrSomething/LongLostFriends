...
@Check if unit has Last Legs
mov		r10,r0
mov		r0,r9
ldr		r3,GetRangeBitfield+8
ldr		r1,GetRangeBitfield+12
bl		goto_r3
cmp		r0,#0
...
@Get unit's mov
mov		r0,r9
ldr		r3,GetRangeBitfield+16
bl		goto_r3

@If unit can't mov, then skip checking distance
cmp		r0, #0
beq		ContinueNormalCheck

@If tile requires full movement, don't draw range for that tile
mov		r1,r10
cmp		r0,r1
beq		DecrementX
