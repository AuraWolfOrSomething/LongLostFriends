...
PackGameSaveUnit.lop_items:
	...
	@since mag is not being used, store fatigue here instead
	ldr r3, =CharacterStructFatigueByte
	ldrb r3, [ r3 ]
	ldrb r2, [r1, r3]	 @ r1 = u->fatiguebyte
	strb r2, [r0, #0x04]	 @ su->fatiguebyte = u->fatiguebyte
...
UnpackGameSaveUnit.lop_items:
	...
	@since mag is unused, load fatigue
	ldr r3, =CharacterStructFatigueByte
	ldrb r3, [ r3 ]
	ldrb r2, [r5, #0x04]	 @ r1 = su->fatiguebyte
	strb r2, [r4, r3]	 @ u->fatiguebyte = su->fatiguebyte
