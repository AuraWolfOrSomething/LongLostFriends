...
@.set SS_TalkText, CelerityID+4
@.set SS_FatigueText, CelerityID+4
@.set MSSFatigueGetter, SS_FatigueText+4
@.set SS_TalkText, MSSFatigueGetter+4
@.set SS_TalkText, SS_FatigueText+4
...
.set CharacterCapModifierTable, Get_Palette_Index+4
@.set DrawBarCapModiferGetter, Get_Palette_Index+4
@.equ GetCharge, Get_Palette_Index+4
@.equ SS_FatigueText, Get_Palette_Index+4
...
@draw str or mag
  ...
  beq     NotMag        
    ...
    draw_textID_at 13, 5, textID=0x4ff, growth_func=2
    b       MagStrDone    
  NotMag:
    @draw Str at 13, 3
    draw_textID_at 13, 5, textID=0x4fe, growth_func=2
  MagStrDone:

draw_textID_at 13, 7, textID=0x4EC, growth_func=3 @skl
draw_textID_at 13, 9, textID=0x4ED, growth_func=4 @spd
draw_textID_at 13, 11, textID=0x4ee, growth_func=5 @luck
draw_textID_at 13, 13, textID=0x4ef, growth_func=6 @def
draw_textID_at 13, 15, textID=0x4f0, growth_func=7 @res
...
.ltorg
DrawBarCapModiferGetter:
push	{r4-r5,r14}
mov		r4, r0
mov		r5, r1
bl		CharacterCapModifierTableReference @not the ideal method, but the size of this page makes the reference for ldr too far
...
ldrb	r1,[r3]
cmp	  	r0,r1
blt	  	DrawBar_DefaultEntry

ldrb	r1,[r3,#1]
cmp	  	r0,r1
ble	  	DrawBar_GetEntry

DrawBar_DefaultEntry:
ldrb	r0,[r3,#2]
...
ShowStats:
@draw_status_text_at 21, 15
draw_effect_text_at 13, 3
draw_str_bar_at 16, 5
...
ShowGrowths:
draw_textID_at 13, 3, textID=0x4E9, growth_func=1 @hp name
ldr		r0,[sp,#0xC]
...
draw_textID_at 13, 17, 0x4f6 @move
draw_move_bar_with_getter_at 16, 17
@now next column for real

.set ss_skillloc, (SS_SkillsText - . - 6)
  ldr r0, =ss_skillloc
  add r0, pc
  ldr r0, [r0]
draw_textID_at 23, 3, colour=White @skills

@.set ss_fatigueloc, (SS_FatigueText - . - 6)
@  ldr r0, =ss_fatigueloc
@  add r0, pc
@  ldr r0, [r0]
...
cmp r1,#0x10
bne Nexty
draw_charge_at 26, 3, colour=Green @ChargeGetter
...
CharacterCapModifierTableReference:
ldr		r0,CharacterCapModifierTable
bx		r14
...
@draw_textID_at 13, 17, textID=0x4f1 @affin
