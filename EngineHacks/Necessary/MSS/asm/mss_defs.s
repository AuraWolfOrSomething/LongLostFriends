...
@old macro
.macro OLDdraw_bar_at bar_x, bar_y, getter, offset, bar_id
  mov r0, r8
  blh      \getter
  mov r1, r8  
  mov     r3, #\offset
...
@old macro
.macro OLDdraw_halved_bar_at bar_x, bar_y, getter, offset, bar_id
  mov r0, r8
  blh      \getter
  mov r1, r8  
  mov     r3, #\offset
...
.macro draw_stats_box
  ...
  @The text "Equipment" from the stat box
  mov     r4,#0x0       @0808764C
