...
.set ACTION_DRAWBACK, EALiterals+0x04

DrawBackSelection_OnSelection:
	push {r4-r5, lr}
	...
	ldrb r0, [r5, #0x10]
	strb r0, [r3, #0x13] @ Target new X (old Active)
	ldrb r0, [r5, #0x11]
	strb r0, [r3, #0x14] @ Target new Y (old Active)
	
	ldr r0, ACTION_DRAWBACK
